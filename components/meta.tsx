      ...
      case "":
        return (
          <>
            ...
            <meta
              property="og:title"
              content="Eric Rawn's Portfolio Site"
            ></meta>
          </>
        );
      case "quickpose/":
        return (
          <>
            <meta
              name="description"
              content={`Quickpose: A Version Control Tool for Processing`}
            />
            <meta
              property="og:image"
              content={
                "https://github.com/erawn/Quickpose/blob/ab4f533c0e6f3f2c45337b2157b81a9e43fff7bc/assets/quickpose-social.png?raw=true"
              }
            />
            <meta
              property="og:title"
  ...
  return (
    <Head>
      ...
      <meta
        ...
        content={"/favicon/" + subpage + "browserconfig.xml"}
      />
